...
function handleFormSubmit(event) {
  ...
  var shoppingListItemEl = $(
    '<li class="flex-row justify-space-between align-center p-2 bg-light text-dark li-class">'
  );
...
shoppingListEl.on('click','.delete-item-btn', handleDlt)
