...
// setting the PORT to a value of 3001
const PORT = 3001;

// setting app to be Express.js
const app = express();

// telling express to parse JSON content
app.use(express.json());

// urlencoded is a body parser when true it is using the qs library
app.use(express.urlencoded({ extended: true }));

// telling the app where the static assets are located like the html, css and js
app.use(express.static('public'));

// setting the root route of the server to the index.html in the public folder
app.get('/', (req, res) =>
...
app.post('/api/reviews', (req, res) => {
  ...
  // creating an object for the body
